...
### Примечания
- Для сборки frontend'f используется npm vite. Он нужен только ради бандлов, шаблонами занимается django.

## TODO
- Вынести в slider шаблон слайдера или вообще удалить его
